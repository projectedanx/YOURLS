...
- **Genesis Block Initialization:** The Symbolic Scar Registry is initialized as empty; the `chapter_manifest.json` template is populated with the book's structural outline (from Phase 1-THINK).
